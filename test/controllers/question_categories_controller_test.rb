...
class QuestionCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create question_category" do
    assert_difference('QuestionCategory.count') do
      post question_categories_url, params: { question_category: { is_active: @question_category.is_active, label: @question_category.label } }
    end
  ...
  test "should update question_category" do
    patch question_category_url(@question_category), params: { question_category: { is_active: @question_category.is_active, label: @question_category.label } }
